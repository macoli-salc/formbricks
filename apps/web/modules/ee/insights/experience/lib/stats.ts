...
export const getStats = async (environmentId: string, statsFrom?: Date): Promise<TStats> => {
  ...
  try {
    ...
    // the sentiment score is the ratio of positive to total (positive + negative) sentiment counts
    // For this we ignore neutral sentiment counts
