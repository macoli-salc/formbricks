...
export default function CertificatePage() {
  ...
  const generatePDF = async () => {
    ...
    try {
      // Importação dinâmica do html2pdf para evitar erro de SSR
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100">
      ...
      <div className="bg-gradient-to-r px-4 py-2 shadow-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between text-sm">
          <div className="flex items-center gap-2">
            <img src="/escuta.svg" alt="Escuta" className="h-5" />
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-8 overflow-hidden rounded-lg border border-slate-200 bg-white shadow-lg">
          ...
          {!formData ? (
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 p-8">
                ...
                <div className="border-t border-slate-200 pt-4">
                  ...
                  <p className="mt-3 text-center text-xs text-slate-500">
                    Ao emitir o certificado, você concorda com a veracidade das informações fornecidas.
                  </p>
                </div>
              </form>
            </div>
            ...
            <div className="mb-6 text-center">
              ...
              <button
                ...
                className="ml-4 inline-flex items-center gap-2 rounded-lg bg-[#E2377B] px-6 py-3 font-semibold text-white shadow-md transition-all duration-200 hover:bg-[#C92F6B] hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-50">
                {isGenerating ? (
                  <>
          ...
          {formData && (
            <>
              {/* Preview do certificado (visível na tela) */}
              <div className="mt-8 rounded-lg bg-white p-4 shadow-2xl sm:p-8">
                <div
                  style={{
                    width: "100%",
                    maxWidth: "900px",
                  ...
                  <p
                    ...
                    participou no dia <span style={{ fontWeight: "bold" }}>08 de novembro de 2025</span>, do{" "}
                  ...
                  <p
                    ...
                    Carga Horária: <span style={{ fontWeight: "bold" }}>06 horas.</span>
                  </p>
              ...
              {/* Div escondida para gerar PDF (tamanho exato A4 landscape) */}
