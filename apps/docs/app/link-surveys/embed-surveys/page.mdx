...
<div style="position: relative; height:100vh; max-height:100vh; overflow:auto;">
  <iframe
    src="https://app.escuta.ai/s/<your-surveyId>"
    frameborder="0"
...
window.addEventListener("message", (event) => {
  // Replace 'https://app.escuta.ai' with the actual web app url
  if (event.origin === "https://app.escuta.ai" && event.data === "formbricksSurveyCompleted") {
