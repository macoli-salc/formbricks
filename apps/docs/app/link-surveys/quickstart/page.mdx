...
While you can [self-host](/self-hosting/deployment) Formbricks, but the quickest and easiest way to get started is with the free Cloud plan. Just [sign up here](https://app.escuta.ai/auth/signup) and click through the onboarding, until you’re here:
