...
2. Create a [free Formbricks account](https://app.escuta.ai/auth/signup)
...
This is super straight forward: Go to [app.formbricks.com/auth/signup](https://app.escuta.ai/auth/signup), create the account, verify your email and you’re in!
