...
1. Go to your settings on [app.formbricks.com](https://app.escuta.ai).
...
<Row>
  <Col>
    ...
    1. Go to settings on [app.formbricks.com](https://app.escuta.ai/).
    2. Go to page “API keys”.
