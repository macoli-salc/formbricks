...
1. Create new 'Improve Newsletter Content' survey at [app.formbricks.com](https://app.escuta.ai/)
...
If you don't have an account yet, create one at [app.formbricks.com](https://app.escuta.ai/auth/signup)
